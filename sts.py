...
sts_dataset_path = '/musicData/multiQA_10_29/data_7_3_3'
...
model_save_path = 'finetuned_model_7_7_1/model_c'
...
with gzip.open(sts_dataset_path, 'rt', encoding='utf8') as fIn:
    ...
    for row in reader:
        ...
        inp_example = InputExample(texts=[row['Q'], row['Q\'']], label=score)
